...
Agent Exposure View Validation
...
The agent exposure view should reproduce the ranking obtained through BA-010.

## Actual Result

The ranking generated by `vw_agent_exposure_summary` matches BA-010.

The view also calculates high-value claim counts for each agent.
...
The validated view can be reused reliably for reporting and future Power BI dashboards without rewriting the underlying aggregation logic.
